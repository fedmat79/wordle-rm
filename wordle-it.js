this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  var Aa = ["pisto", "nasca", "bella", "panza", "sacco", "ganzo", "sgaro", "vorpe", "tosto", "monco", "tocco", "zeppa", "manco", "porca", "sveja", "tanfa", "fette", "stira", "fotte", "mazzo", "mossa", "pacco", "buffi", "fessa", "zeppo", "spada", "spago", "cifra", "nisba", "fissa", "zompa", "gnudo", "botto", "grana", "porco", "antro", "torta", "benza", "balla", "cazzo", "corpo", "sbava", "vorta", "cocco", "bucio", "cippa", "vaffa", "avoja", "ceppa", "dalli", "stica", "tappo", "cozza", "erore", "lassa", "troja", "corca", "sfiga", "zella", "batte", "carca", "corpi", "scola", "cocca", "guera","forta", "tappa", "cioce", "rinco", "zompo", "borza", "fanga", "rotto", "cucco", "artro", "fesso", "loffa", "ndove", "pizza", "calla", "bozzo", "zuppo", "pippa", "robba", "tozzo", "crapa", "merda", "sceje", "sgama", "purce", "cozzi", "mette", "nfame", "monno", "rogna", "peppa", "tanfo", "scudo", "dasse", "cesso", "pizzo", "cecio", "vacce", "porpa", "dindi", "lagna", "zizze", "borze", "sbafo", "jella", "puzza", "vurva", "dorce", "carce", "pasce", "stamo", "sorfa", "datte", "corpa","avemo", "corpe", "dacce", "froci", "sbajo", "scote", "marva", "buzzo", "ferma", "oglio", "scajo","sorca", "vorte", "pezza", "spoje", "fasse", "usace", "tarco", "scoce", "toppa", "carma", "gorfo", "scula", "sarva", "vatte", "sculo", "farco", "sarme", "salle", "carza", "zorfo", "berva", "corga", "scole", "murta", "scaje", "forto", "corma", "sanne","corgo", "sarve", "torgo", "sarse"],
