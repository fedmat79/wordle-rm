this.wordle = this.wordle || {}, this.wordle.bundle = function(e) {
  ...
  Sa.innerHTML = '\n  <style>\n  .setting {\n    display: flex;\n    justify-content: space-between;\n    align-items: center;\n    border-bottom: 1px solid var(--color-tone-4);\n    padding: 16px 0;\n  }\n\n  a, a:visited {\n    color: var(--color-tone-2);\n  }\n\n  .title {\n    font-size: 18px;\n  }\n  .text {\n    padding-right: 8px;\n  }\n  .description {\n    font-size: 12px;\n    color: var(--color-tone-2);\n  }\n\n  #footnote {\n    position: absolute;\n    bottom: 0;\n    right: 0;\n    padding: 16px;\n    color: var(--color-tone-2);\n    font-size: 12px;\n    text-align: right;\n  }\n\n  @media only screen and (min-device-width : 320px) and (max-device-width : 480px) {\n    .setting {\n      padding: 16px;\n    }\n  }\n\n  </style>\n  <div class="sections">\n    <section>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Il gioco si fa duro</div>\n          <div class="description">Ogni lettera ch’hai beccato la devi usa’ sempre dopo</div>\n        </div>\n        <div class="control">\n          <game-switch id="hard-mode" name="hard-mode"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Te piace cupo er ggioco</div>\n        </div>\n        <div class="control">\n          <game-switch id="dark-theme" name="dark-theme"></game-switch>\n        </div>\n      </div>\n      <div class="setting">\n        <div class="text">\n          <div class="title">Te piace de tutti i colori 🌈</div>\n        </div>\n        <div class="control">\n          <game-switch id="color-blind-theme" name="color-blind-theme"></game-switch>\n        </div>\n     <div>\n';
  var _a = function(e) {
      n(t, e);
      var a = h(t);
  ...
  var Qa = "IN_PROGRESS",
      Za = "WIN",
      es = "FAIL",
      as = ["C'hai più culo che animo", "Sei er mejo!", "Ammazza", "Onesto", "Nzomma", "Vabbe, va..."],
      ss = function(e) {
          n(t, e);
          var a = h(t);
          ...
          return o(t, [{
              ...
              value: function() {
                  if (5 === this.tileIndex && !(this.rowIndex >= 6)) {
                      ...
                      if (e = s, !La.includes(e) && !Aa.includes(e)) return a.setAttribute("invalid", ""), void this.addToast("Che stai a dì?!?!");
                      if (this.hardMode) {
                          var t = function(e, a, s) {
                              ...
                              o = t.validGuess,
                              r = t.errorMessage;
                          if (!o) return a.setAttribute("invalid", ""), void this.addToast(r || "Te senti bbravo")
                      }
                      var n = function(e, a) {
              ...
              value: function() {
                  ...
                  this.$game.addEventListener("game-key-press", (function(a) {
                      ...
                      var s = e.$game.querySelector("game-page"),
                          t = document.createTextNode("C’hai le fisime");
                      s.appendChild(t);
                      ...
                      var s = e.$game.querySelector("game-page"),
                          t = document.createTextNode("’e regole der ggioco");
                      s.appendChild(t);
                  ...
                  this.shadowRoot.appendChild(rs.content.cloneNode(!0)), this.$keyboard = this.shadowRoot.getElementById("keyboard"), this.$keyboard.addEventListener("click", (function(a) {
                      ...
                      s.classList.add("row"), a.forEach((function(e) {
                          ...
                          if (e >= "a" && e <= "z" || "←" === e || "↵" === e) {
                              ...
                              "↵" == e && (a.textContent = "Daje", a.classList.add("one-and-a-half"))
  ...
  cs.innerHTML = '\n  <style>\n    .container {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      padding: 16px 0; \n    }\n    h1 {\n      font-weight: 700;\n      font-size: 16px;\n      letter-spacing: 0.5px;\n      text-transform: uppercase;\n      text-align: center;\n      margin-bottom: 10px;\n    }\n  \n    #statistics {\n      display: flex;\n      margin-bottom: \n    }\n\n    .statistic-container {\n      flex: 1;\n    }\n\n    .statistic-container .statistic {\n      font-size: 36px;\n      font-weight: 400;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      text-align: center;\n      letter-spacing: 0.05em;\n      font-variant-numeric: proportional-nums;\n    }\n\n    .statistic.timer {\n      font-variant-numeric: initial;\n    }\n\n    .statistic-container .label {\n      font-size: 12px;\n      display: flex;\n      align-items: center;\n      justify-content: center;\n      text-align: center;\n    }\n\n    #guess-distribution {\n      width: 80%;\n    }\n\n    .graph-container {\n      width: 100%;\n      height: 20px;\n      display: flex;\n      align-items: center;\n      padding-bottom: 4px;\n      font-size: 14px;\n      line-height: 20px;\n    }\n\n    .graph-container .graph {\n      width: 100%;\n      height: 100%;\n      padding-left: 4px;\n    }\n\n    .graph-container .graph .graph-bar {\n      height: 100%;\n      /* Assume no wins */\n      width: 0%;\n      position: relative;\n      background-color: var(--color-absent);\n      display: flex;\n      justify-content: center;\n    }\n\n    .graph-container .graph .graph-bar.highlight {\n      background-color: var(--color-correct);\n    }\n\n    .graph-container .graph .graph-bar.align-right {\n      justify-content: flex-end;\n      padding-right: 8px;\n    }\n\n    .graph-container .graph .num-guesses {\n      font-weight: bold;\n      color: var(--tile-text-color);\n    }\n\n    #statistics,\n    #guess-distribution {\n      padding-bottom: 10px;\n    }\n\n    .footer {\n      display: flex;\n      width: 100%;\n    }\n\n    .countdown {\n      border-right: 1px solid var(--color-tone-1);\n      padding-right: 12px;\n      width: 50%;\n    }\n\n    .share {\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      padding-left: 12px;\n      width: 50%;\n    }\n\n    button#share-button {\n      background-color: var(--key-bg-correct);\n      color: var(--key-evaluated-text-color);\n      font-family: inherit;\n      font-weight: bold;\n      border-radius: 4px;\n      cursor: pointer;\n      border: none;\n      user-select: none;\n      display: flex;\n      justify-content: center;\n      align-items: center;\n      text-transform: uppercase;\n      -webkit-tap-highlight-color: rgba(0,0,0,0.3);\n      width: 80%;\n      font-size: 20px;\n      height: 52px;\n      -webkit-filter: brightness(100%);\n    }\n    button#share-button:hover {\n      opacity: 0.9;\n    }\n    button#share-button game-icon {\n      width: 24px;\n      height: 24px;\n      padding-left: 8px;\n    }\n  </style>\n\n  <div class="container">\n    <h1>Er tabbellone</h1>\n    <div id="statistics"></div>\n    <h1>’e striscette verdi</h1>\n    <div id="guess-distribution"></div>\n    <div class="footer">\n      <div class="countdown">\n        <h1>Quanto devi aspetta’ pe’ riprovacce</h1>\n        <div id="timer">\n          <div class="statistic-container">\n            <div class="statistic timer">\n              <countdown-timer></countdown-timer>\n            </div>\n          </div>\n        </div>\n      </div>\n      <div class="share">\n        <button id="share-button">\n          Lo voi di’ a quarcuno \n        </button>\n      </div>\n    </div>\n  </div>\n';
  var ps = document.createElement("template");
  ps.innerHTML = '\n  <div class="statistic-container">\n    <div class="statistic"></div>\n    <div class="label"></div>\n  </div>\n';
  var ms = document.createElement("template");
  ms.innerHTML = '\n    <div class="graph-container">\n      <div class="guess"></div>\n      <div class="graph">\n        <div class="graph-bar">\n          <div class="num-guesses">\n        </div>\n      </div>\n      </div>\n    </div>\n';
  var hs = {
          currentStreak: "Beccate de fila",
          maxStreak: "Record vittorie de fila",
          winPercentage: "% bbone",
          gamesPlayed: "Quant’ hai ggiocato",
          gamesWon: "Quante vorte t’ha detto bbene",
          averageGuesses: "Più o meno quante ne spari prima de beccacce"
      },
      ys = function(e) {
          n(t, e);
          var a = h(t);
  ...
  var fs = document.createElement("template");
   fs.innerHTML = '\n  <style>\n  .instructions {\n    font-size: 14px;\n    color: var(--color-tone-1)\n  }\n\n  .examples {\n    border-bottom: 1px solid var(--color-tone-4);\n    border-top: 1px solid var(--color-tone-4);\n  }\n\n  .example {\n    margin-top: 24px;\n    margin-bottom: 24px;\n  }\n\n  game-tile {\n    width: 40px;\n    height: 40px;\n  }\n\n  :host([page]) section {\n    padding: 16px;\n    padding-top: 0px;\n  }\n\n  </style>\n  <section>\n    <div class="instructions">\n      <p>Cerca de becca’ ’e parole <strong>ggiuste</strong> de 🖐️ lettere ’n 6 corpi (meno è mejo).</p>\n      <p>🟥ROMA🟧 è ’n giochetto romanesco (pe’ gnente ufficiale) copiato da <a href="https://pietroppeter.github.io/wordle-it/">PAR🇮🇹LE</a> che poi ha copiato da <a href="https://www.nytimes.com/games/wordle/index.html">WORDLE</a></p>\n      <p>Dopo ogni fregnaccia che scrivi, ’e tessere s’aribbarteno pe’ fatte vede quanto sei ’na pippa.</p>\n      <div class="examples">\n        <div class="example">\n          <div class="row">\n            <game-tile letter="b" evaluation="correct" reveal></game-tile>\n            <game-tile letter="e"></game-tile>\n            <game-tile letter="n"></game-tile>\n            <game-tile letter="z"></game-tile>\n            <game-tile letter="a"></game-tile>\n          </div>\n          <p>Hai beccato che ’a <strong>B</strong> sta ner posto ggiusto.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="r" evaluation="present" reveal></game-tile>\n            <game-tile letter="c"></game-tile>\n            <game-tile letter="a"></game-tile>\n          </div>\n          <p>A lettera <strong>R</strong> ce sta ma l’hai messa a cazzo.</p>\n        </div>\n        <div class="example">\n          <div class="row">\n            <game-tile letter="p"></game-tile>\n            <game-tile letter="a"></game-tile>\n            <game-tile letter="g"></game-tile>\n            <game-tile letter="h" evaluation="absent" reveal></game-tile>\n            <game-tile letter="i"></game-tile>\n          </div>\n     <p>A lettera <strong>H</strong> ta’a sei sognata te, nun ce sta.</p>\n        </div>\n      </div>\n   <strong><p>Poi mette tutte ’e parola itagliane che vvoi, ma ricordate che vinci solo co quelle romanesche.  <strong></p>    <p><strong>’na parola nova ogni ggiorno ... si non te stufi prima <strong></p>\n    </div>\n  </section>\n';
  var ks = function(e) {
      n(t, e);
      var a = h(t);
